...
prospect of detecting nebular emission from $r$-process elements, additionally
provides a tantalizing opportunity to find the first direct evidence for the
production site.
